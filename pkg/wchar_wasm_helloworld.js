...
* @returns {number}
*/
export function example_one(v) {
    const ret = wasm.example_one(v);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_alert_2185050aabbcd9f3 = function(arg0, arg1) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wchar_wasm_helloworld_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
